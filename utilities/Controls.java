...
public final class Controls {
	 ...
	 *  the small data sets only) or connect R to handle huge matrices using sparce matrix operations. 
	 *  Default is false - use Apache. */
	public static boolean BIG_DATA = false;
	/** This controls whether to a Java solver or the R solver*/
	public static boolean JAVA_OPTIMIZATION = true;
	/** To print detailed descriptive information during fitting*/
	public static boolean PRINT = false;
	/** Whether to use the log LIKELIHOOD*/	
