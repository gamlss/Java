...
public final class Gamlss {
	...
	private BlockRealMatrix resultsMatrix ;
	/**
	 * 
	 ...
	 */
	public Gamlss(final ArrayRealVector y, 
	...
	public void saveFittedDistributionParameters(String fileName)
	{
		saveFittedDistributionParameters(fileName, this.resultsMatrix);
	}
		
	public void saveFittedDistributionParameters(String fileName, BlockRealMatrix resultsMatrix)
	{
		MatrixFunctions.matrixWriteCSV(
				fileName, resultsMatrix);
	}
	
	public void loadLibrary(String library)
	{
		R.getInstance().loadLibrary(library); 
	}
	...
	public void plotWP(double[] residuals) 
	{
			...
			R.getInstance().plotWP(residuals);
